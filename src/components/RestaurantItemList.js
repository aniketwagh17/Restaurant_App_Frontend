...
//
    ...
    const onChangeSearchTitle = e => {
      ...
      const removeAllItems = () =>{
          swal({
            title: "Are you sure?",
            text: "Are you sure that you want to remove all the items?",
            icon: "warning",
            dangerMode: true,
            buttons: ["Cancel", "Yes!"],
        }).then(function(value) {
            ...
            .then(() =>{
                swal("Deleted!", "Your Food Items have been removed!", "success");
                getAllItems();
            })
            .catch(err =>{
                console.log(err.response)
...
<div className="list row">
      <div className="col-md-4">
        <div className="input-group mb-3">
          <input type="text" className="form-control" placeholder="Search Your Favourait Item..."
            value={searchTitle} onChange={onChangeSearchTitle}/>
          <div className="input-group-append">
            <button className="btn btn-success" type="button" onClick={findByTitle}>
              Search
            </button>
          </div>
        </div>
            ...
            <button className='btn btn-danger my-4' onClick={removeAllItems}>Remove All Items</button>
